...
-- MAV views
GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesBrowse to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSearch to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSelectAllArchiveTags to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSelectAllArchiveTypes to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSelectByArchiveType to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSelectByInterchangeId to [$(BizTalkMonitorROGroup)]
GO

GRANT EXECUTE ON MessageArchiveHistory.dbo.sp_MessagesSelectByMessageId to [$(BizTalkMonitorROGroup)]
GO
