...
-- Description:	[sp_MessagesSelectByInterchangeId] 
-- =============================================
CREATE PROCEDURE [dbo].[sp_MessagesSelectByInterchangeId]
...
BEGIN
   ...
   SELECT * 
	FROM
		...
		WHERE InterchangeId = @interchangeId) as ArchiveChunk
	...
	FROM
		...
		WHERE InterchangeId = @interchangeId) AS HistoryChunk
