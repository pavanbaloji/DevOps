...
-- Description:	[sp_MessagesBrowse] 
-- =============================================
CREATE PROCEDURE [dbo].[sp_MessagesBrowse]
...
BEGIN
	...
	(
		...
		FROM
			...
			FROM   
			(SELECT TOP (@maxResults) [Extent1].[MessageId] AS [MessageId], [Extent1].[InterchangeId] AS [InterchangeId], 
			[Extent1].[MessageType] AS [MessageType], [Extent1].[ActivityId] AS [ActivityId], [Extent1].[Tag] AS [Tag], [Extent1].[InsertedDate] AS [InsertedDate], 
			[Extent1].[ExpiryDate] AS [ExpiryDate], [Extent1].[ArchiveTypeId] AS [ArchiveTypeId], [Extent1].[SourceSystemId] AS [SourceSystemId],
			 [Extent1].[TargetSystemId] AS [TargetSystemId], [Extent1].[Description] AS [Description]
				FROM [$(MessageArchive)].[dbo].[Message] AS [Extent1] WITH(NOLOCK) order by [InsertedDate] Desc) AS [Limit1]
		...
		FROM
			...
			[Extent2].[TextData] AS [TextData]
			FROM   
			(SELECT TOP (@maxResults) [Extent1].[MessageId] AS [MessageId], [Extent1].[InterchangeId] AS [InterchangeId], [Extent1].[MessageType] AS [MessageType], [Extent1].[ActivityId] AS [ActivityId], [Extent1].[Tag] AS [Tag], [Extent1].[InsertedDate] AS [InsertedDate], [Extent1].[ExpiryDate] AS [ExpiryDate], [Extent1].[ArchiveTypeId] AS [ArchiveTypeId], [Extent1].[SourceSystemId] AS [SourceSystemId], [Extent1].[TargetSystemId] AS [TargetSystemId], [Extent1].[Description] AS [Description]
				FROM [dbo].[Message] AS [Extent1] WITH(NOLOCK) order by [InsertedDate] Desc) AS [Limit1]
